...
public class Cell extends ACell {
    ...
    */
    ...
    public boolean isValid(Node node1, Node node2) {
        ...
        if(this.isTransverse(node1, node2)) {
        ...
        if(this.isLongitudinal(node1, node2)) {
            double nodesAngle = Math.toDegrees(node1.getPoint().toVector3D().angle(node2.getPoint().toVector3D()));
    ...
    private boolean isTransverse(Node node1, Node node2) {
        boolean result = false;
        if(     (node1.getDtype() == DetectorType.SVTT && (node2.getDtype() == DetectorType.SVTT) ) || 
                (node1.getDtype() == DetectorType.SVTT && (node2.getDtype() == DetectorType.BMTZ) ) || 
                (node1.getDtype() == DetectorType.BMTZ && (node2.getDtype() == DetectorType.BMTZ) ) ||
                (node2.getDtype() == DetectorType.SVTT && (node1.getDtype() == DetectorType.SVTT) ) || 
                (node2.getDtype() == DetectorType.SVTT && (node1.getDtype() == DetectorType.BMTZ) ) || 
                (node2.getDtype() == DetectorType.BMTZ && (node1.getDtype() == DetectorType.BMTZ) ) ) {
            result = true;
        }
        return result;
    }

    private boolean isLongitudinal(Node node1, Node node2) {
        boolean result = false;
        if(     (node1.getDtype() == DetectorType.SVTL && (node2.getDtype() == DetectorType.SVTL) ) || 
                (node1.getDtype() == DetectorType.SVTL && (node2.getDtype() == DetectorType.BMTC) ) || 
                (node1.getDtype() == DetectorType.BMTC && (node2.getDtype() == DetectorType.BMTC) ) ||
                (node2.getDtype() == DetectorType.SVTL && (node1.getDtype() == DetectorType.SVTL) ) || 
                (node2.getDtype() == DetectorType.SVTL && (node1.getDtype() == DetectorType.BMTC) ) || 
                (node2.getDtype() == DetectorType.BMTC && (node1.getDtype() == DetectorType.BMTC) ) ) {
            result = true;
        }
        return result;
    }
