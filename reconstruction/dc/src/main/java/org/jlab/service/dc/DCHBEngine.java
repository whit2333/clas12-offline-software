...
public class DCHBEngine extends DCEngine {
    ...
    public boolean processDataEvent(DataEvent event) {
       ...
       for(Segment se : segments) {
        ...
        CrossList crosslist = crossLister.candCrossLists(crosses, false, super.getConstantsManager().getConstants(newRun, "/calibration/dc/time_to_distance/time2dist"), dcDetector, null, swimmer);
        ...
        CrossList pcrosslist = crossLister.candCrossLists(pcrosses, false, 
                super.getConstantsManager().getConstants(newRun, "/calibration/dc/time_to_distance/time2dist"), dcDetector, null, swimmer);
